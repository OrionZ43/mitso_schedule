...
подгрупп, страницы подробностей, сохранённых справок и настроек — в `screenshots/`. Фото справки
...
| | |
|---|---|
| ![Расписание](screenshots/1-schedule-light.png) | ![Пропуски](screenshots/2-absences-light.png) |
| ![Заметки](screenshots/3-notes-light.png) | ![Профиль](screenshots/4-profile-light.png) |
| ![Подгруппы](screenshots/7-subgroups-light.png) | ![Подробности пары](screenshots/8-lesson-details-light.png) |
...
- **Профиль** — про человека: чьё расписание показываем (группа или преподаватель) и всё
  про лицевой счёт, включая уведомление о долге и отключение счёта. У преподавателя раздел
  счёта скрыт: student.mitso.by — студенческий.
- **Настройки** (за шестерёнкой) — про приложение: «Вид» (тема, цвета, значок),
  «Устройства» (компактное окно, автозапуск, часы рядом), «О приложении» (версия и
  обновления) и подпись студии со ссылкой.
